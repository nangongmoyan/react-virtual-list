...
import { useRangeForVariable1 } from "../hooks/useRangeForVariable1";
...
const VariableSizeList2:React.FC<VariableSizeListProps> = (props) => {
  ...
  const {startIndex, endIndex, setScrollTop } = useRangeForVariable1(props, instanceProps)
